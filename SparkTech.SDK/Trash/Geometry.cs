namespace SparkTech.SDK.Util.Vector
{
    ...
    public static class Geometry
    {
        ...
        {
            var deltaACy = lineSegment1Start.Y - lineSegment2Start.Y;
            var deltaDCx = lineSegment2End.X - lineSegment2Start.X;
            var deltaACx = lineSegment1Start.X - lineSegment2Start.X;
            var deltaDCy = lineSegment2End.Y - lineSegment2Start.Y;
            var deltaBAx = lineSegment1End.X - lineSegment1Start.X;
            var deltaBAy = lineSegment1End.Y - lineSegment1Start.Y;
            ...
            return new IntersectionResult(
                true,
                new Vector2(lineSegment1Start.X + r * deltaBAx, lineSegment1Start.Y + r * deltaBAy));
        }
